...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.n_obs_height = 9
        self.visions = np.ones(self.map_params["n_agents"], dtype=float)*9
        # unit shoot range is set to 2/3 shight range
    ...
    def unit_shoot_range(self, agent_id):
        ...
        if self.use_unit_ranges:
            ...
            return  self.visions[agent_id]*2/3
    ...
    def unit_sight_range(self, agent_id):
        ...
        if self.use_unit_ranges:
            ...
            return self.visions[agent_id]

    def change_unit_capability_range(self, values):
        """Changes the sight range for an agent."""
        for i in range(self.n_agents):
            self.visions[i] = values[i]
            ...
            for t_id, t_unit in target_items:
                if t_unit.health > 0:
                    if not self.action_mask:
                        ...
                        can_shoot = (
                            dist <= shoot_range and dist <= self.unit_sight_range(agent_id)
